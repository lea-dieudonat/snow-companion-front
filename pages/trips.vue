...
<template>
  <div class="p-4 md:p-8">
    ...
    <div class="mb-8 text-center">
      <UIcon name="i-lucide-map" class="text-5xl text-snow-50 mx-auto mb-4" />
      <h2 class="text-snow-50 text-3xl md:text-4xl font-bold m-0 mb-2 drop-shadow-lg">Planning Trips</h2>
    ...
    <div class="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-3 gap-6">
      ...
      <div class="lg:col-span-1">
        <div class="lg:sticky lg:top-24 space-y-6">
          ...
          <UCard v-if="compareStations.length > 0">
            <template #header>
              <h4 class="font-semibold text-mountain-900 flex items-center gap-2">
            ...
            <div class="space-y-2">
              <div v-for="station in compareStations" :key="station.id"
                class="flex justify-between items-center bg-snow-100 rounded-lg px-3 py-2">
      ...
      <div class="lg:col-span-2">
        ...
        <div v-if="loading" class="text-center py-12">
          <UIcon name="i-lucide-loader-2" class="text-6xl text-snow-50 animate-spin mx-auto mb-4" />
          <p class="text-snow-100 text-lg">Chargement des stations...</p>
        </div>

        <template v-else>
          <p class="text-xl font-bold text-snow-50 mb-4 flex items-center gap-2">
          ...
          <div v-if="filteredStations.length === 0" class="text-center py-12">
            <UIcon name="i-lucide-search-x" class="text-6xl text-snow-100 mx-auto mb-4" />
